const About = () => {
    return (
      <section id="about" className="min-h-screen container bg-zinc-800 border-dashed border-blue-600 border-t-4 text-white flex flex-col items-center justify-center p-6">
